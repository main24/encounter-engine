...
Функционал: 89 Варианты написания кодов
  ...
  Предыстория:
    Допустим админом создана игра "Найти и выжить"
    ...
    И для уровня "Операция Empty" есть следующие коды:
      ...
      | фломастер       | flomaster       |
      | код2уровня      |                 |
    И зарегистрирована команда "Discovery"
    И админ зарегистрировал команду "Discovery" на участие в игре "Найти и выжить"
    И игра "Найти и выжить" уже начата
    И команда Discovery находится на уровне "Операция Empty" игры "Найти и выжить"
    Допустим я логинюсь как Discovery
