...
Функционал: Ведение лога ответов
  ...
  Предыстория:
    ...
    И админ добавляет задание "Апартаменты рептилии" с кодом "croc" в игру "Приключения покемона"
    И админ добавляет задание "Сбор металлолома" с кодом "metal" в игру "Приключения покемона"
  ...
  Сценарий: Автор смотрит лог ответов команды по заданию
    Допустим в "2010-07-02 15:05" команда "Shapoklyak" на задании "Коробка с апельсинами" игры "Приключения покемона" ввела код "мандарин"
    И в "2010-07-02 15:10" команда "Shapoklyak" на задании "Коробка с апельсинами" игры "Приключения покемона" ввела код "ананас"
  ...
  Сценарий: Игрок заканчивает игру и получает доступ к полному логу
    ...
    Если я логинюсь как Crocodiles
    И захожу в личный кабинет
  ...
  Сценарий: Автор просматривает полный лог ответов (для игрока он аналогчен)
    Допустим в "2010-07-02 15:05" команда "Shapoklyak" на задании "Коробка с апельсинами" игры "Приключения покемона" ввела код "мандарин"
    И в "2010-07-02 15:10" команда "Shapoklyak" на задании "Коробка с апельсинами" игры "Приключения покемона" ввела код "apelsin"
