...
Функционал: Завершение игры автором
  ...
  Предыстория:
    ...
    И админом создана игра "Рыбалка"
    Допустим зарегистрирована команда "ESDP10"
    И админ зарегистрировал команду "ESDP10" на участие в игре "Рыбалка"
    И зарегистрирована команда "ESDP11"
    И админ зарегистрировал команду "ESDP11" на участие в игре "Рыбалка"
